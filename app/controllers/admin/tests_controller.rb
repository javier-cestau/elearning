class Admin::TestsController < ApplicationController
 ...
 before_action :get_object_id, only: %i[simple multiple true_false]
 ...
 def test_params
  params.require(:test).permit(:required, :attemps_limits, :time_limit, :min_grade,:deadline, :start_date, :description, questions_attributes: [:description,:points, :type_question_id, answers: [], answers_correct: []])
 end
